...
RUN apt-get update && apt-get install -y --no-install-recommends \
         libsm6 build-essential openjdk-11-jdk-headless wget unzip curl git vim htop \
         libxext6 \
         libxrender-dev \
         ffmpeg && \
...
RUN pip install jupyter_tensorboard torchvision scikit-image python-terrier
